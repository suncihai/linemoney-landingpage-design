jQuery(document).ready(function($){
	...
	$('#hover_show_countries').click(function(){
	   if($('#country_panel').css("display")=="none"){
           $('#country_panel').fadeIn();
	   }else{
           $('#country_panel').fadeOut();
	   }
	});
	...
	$(".show_countries").click(function(){
   	  switch($(this).attr("id")){
          case "China":
             $(location).attr('href',"https://www.linemoney.com.cn");
    		     break;
    		  case "USA":
    		     $(location).attr('href',"https://www.linemoney.us");
    		     break;
    		  case "Japan":
    		     $(location).attr('href',"https://www.linemoney.co.jp");
    		     break;
    		  case "China-Hongkong":
    		     $(location).attr('href',"https://www.linemoneyhk.com");
    		     break;
    		  case "Philippines":
    		     $(location).attr('href',"https://www.linemoney.ph");
    		     break;      
    		  default:
    		     break;
   	  }
